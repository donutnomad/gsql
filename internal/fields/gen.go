...
type FieldType struct {
	Name      string // e.g., "IntExprField"
	InnerExpr string // e.g., "IntExpr"
	InnerName string // e.g., "IntExpr" (field name in struct)
}

var fieldTypes = []FieldType{
	{"IntExprField", "IntExpr", "IntExpr"},
	{"FloatExprField", "FloatExpr", "FloatExpr"},
	{"DecimalExprField", "DecimalExpr", "DecimalExpr"},
	{"TextExprField", "TextExpr", "TextExpr"},
	{"DateTimeExprField", "DateTimeExpr", "DateTimeExpr"},
	{"DateExprField", "DateExpr", "DateExpr"},
	{"TimeExprField", "TimeExpr", "TimeExpr"},
	{"TimestampExprField", "TimestampExpr", "TimestampExpr"},
}
...
func main() {
	...
	if err != nil {
		// 如果格式化失败，输出原始内容以便调试
		os.WriteFile("typed_field_gen.go", buf.Bytes(), 0644)
		panic(err)
	}

	if err := os.WriteFile("typed_field_gen.go", formatted, 0644); err != nil {
		panic(err)
	}
}
