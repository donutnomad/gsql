...
func TestTextExpr_Like(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "UPPER(name)", Vars: nil})
...
func TestTextExpr_LikeWithEscape(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "name", Vars: nil})
...
func TestTextExpr_NotLike(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "LOWER(email)", Vars: nil})
...
func TestTextExpr_Contains(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "description", Vars: nil})
...
func TestTextExpr_HasPrefix(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "code", Vars: nil})
...
func TestTextExpr_HasSuffix(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "filename", Vars: nil})
...
func TestTextExpr_Not(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "status", Vars: nil})
...
func TestTextExpr_As(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "CONCAT(first, last)", Vars: nil})
	field := expr.As("full_name")
	assert.Equal(t, "full_name", field.Name())
}

func TestTextExpr_Cast(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "price_str", Vars: nil})
...
func TestTextExpr_CastSigned(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "amount_str", Vars: nil})
...
func TestTextExpr_CastUnsigned(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "count_str", Vars: nil})
...
func TestTextExpr_CastChar(t *testing.T) {
	expr := NewTextExpr[int](clause.Expr{SQL: "user_id", Vars: nil})
	result := expr.CastChar(10)

	// CastChar 返回 TextExpr[string]
	e := result.Like("123%")
	exprResult, ok := e.(clause.Expr)
	assert.True(t, ok)
...
func TestTextExpr_TypeSafety(t *testing.T) {
	// string 类型
	strExpr := NewTextExpr[string](clause.Expr{SQL: "name", Vars: nil})
	...
	// int 类型（用于数字字符串场景）
	intExpr := NewTextExpr[int](clause.Expr{SQL: "code", Vars: nil})
...
func TestTextExpr_Lower(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "email", Vars: nil})
	result := expr.Lower()
...
func TestTextExpr_Right(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "phone", Vars: nil})
	result := expr.Right(4)
...
func TestTextExpr_Concat(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "first_name", Vars: nil})
...
func TestTextExpr_Repeat(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "'*'", Vars: nil})
...
func TestTextExpr_LPad(t *testing.T) {
	expr := NewTextExpr[string](clause.Expr{SQL: "id", Vars: nil})
...
func TestTextExpr_Chaining(t *testing.T) {
	...
	email := NewTextExpr[string](clause.Expr{SQL: "email", Vars: nil})
