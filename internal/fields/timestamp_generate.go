...
func (e TimestampExpr[T]) Sum() TimestampExpr[T] {
	return NewTimestampExpr[T](e.sumExpr())
}
...
func (e TimestampExpr[T]) Avg() FloatExpr[float64] {
...
func (e TimestampExpr[T]) TimeDiff(other clause.Expression) TimeExpr[T] {
