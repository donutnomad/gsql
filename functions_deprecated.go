...
//
//// Deprecated: 使用 Int/Float/Decimal 的 Mul 方法替代，如 expr1.Mul(expr2)
//func Mul(expr1, expr2 field.Expression) field.Float {
...
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Div 方法替代，如 expr1.Div(expr2)
//func Div(expr1, expr2 field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "? / ?",
//		Vars: []any{expr1, expr2},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Add 方法替代，如 expr1.Add(expr2)
//func Add(expr1, expr2 field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "? + ?",
//		Vars: []any{expr1, expr2},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Sub 方法替代，如 expr1.Sub(expr2)
//func Sub(expr1, expr2 field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "? - ?",
//		Vars: []any{expr1, expr2},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Mod 方法替代，如 expr1.Mod(expr2)
//func Mod(expr1, expr2 field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "? % ?",
//		Vars: []any{expr1, expr2},
//	})
...
//// Deprecated: 使用 String 的 Concat 方法替代，如 textExpr.Concat(args...)
...
//// Deprecated: 使用 String 的 Length 方法替代，如 textExpr.Length()
...
//func LENGTH(str field.Expression) field.Int {
...
//}
//
//// Deprecated: 使用 String 的 CharLength 方法替代，如 textExpr.CharLength()
...
//func CHAR_LENGTH(str field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "CHAR_LENGTH(?)",
//		Vars: []any{str},
//	})
...
//func CHARACTER_LENGTH(str field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
...
//// Deprecated: 使用 String 的 Upper 方法替代，如 textExpr.Upper()
...
//// Deprecated: 使用 String 的 Lower 方法替代，如 textExpr.Lower()
...
//// Deprecated: 使用 String 的 Substring 方法替代，如 textExpr.Substring(pos, length)
...
//// Deprecated: 使用 String 的 Left 方法替代，如 textExpr.Left(length)
...
//// Deprecated: 使用 String 的 Right 方法替代，如 textExpr.Right(length)
...
//}
//
//// Deprecated: 使用 String 的 Locate 方法替代，如 textExpr.Locate(substr)
...
//func LOCATE(substr, str field.Expression, pos ...int) field.Int {
//	if len(pos) > 0 {
//		return field.NewIntExpr(clause.Expr{
//			SQL:  "LOCATE(?, ?, ?)",
...
//func INSTR(str, substr field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "INSTR(?, ?)",
//		Vars: []any{str, substr},
//	})
//}
//
//// Deprecated: 使用 String 的 Replace 方法替代，如 textExpr.Replace(from, to)
...
//}
//
//// Deprecated: 使用 String 的 Trim 方法替代，如 textExpr.Trim()
...
//}
//
//// Deprecated: 使用 String 的 LTrim 方法替代，如 textExpr.LTrim()
//// LTRIM 去除字符串左侧的空格
...
//}
//
//// Deprecated: 使用 String 的 RTrim 方法替代，如 textExpr.RTrim()
//// RTRIM 去除字符串右侧的空格
...
//// Deprecated: 使用 Int/Float/Decimal 的 Abs 方法替代，如 expr.Abs()
//// ABS 返回数值的绝对值
//// SELECT ABS(-10);
//// SELECT ABS(10);
//// SELECT ABS(users.balance) FROM users;
//// SELECT * FROM transactions WHERE ABS(amount) > 1000;
//func ABS(x field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "ABS(?)",
//		Vars: []any{x},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Ceil 方法替代，如 expr.Ceil()
//// CEIL 向上取整，返回大于或等于X的最小整数，是CEILING的同义词
//// SELECT CEIL(4.3);
//// SELECT CEIL(4.9);
//// SELECT CEIL(-4.3);
//// SELECT CEIL(price * 1.1) FROM products;
//func CEIL(x field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "CEIL(?)",
//		Vars: []any{x},
//	})
...
//func CEILING(x field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "CEILING(?)",
//		Vars: []any{x},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Floor 方法替代，如 expr.Floor()
//// FLOOR 向下取整，返回小于或等于X的最大整数
//// SELECT FLOOR(4.3);
//// SELECT FLOOR(4.9);
//// SELECT FLOOR(-4.3);
//// SELECT FLOOR(price * 0.9) FROM products;
//func FLOOR(x field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "FLOOR(?)",
//		Vars: []any{x},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Round 方法替代，如 expr.Round(decimals...)
...
//func ROUND(x field.Expression, d ...int) field.Float {
//	if len(d) > 0 {
//		return field.NewFloatExpr(clause.Expr{
//			SQL:  "ROUND(?, ?)",
//			Vars: []any{x, d[0]},
...
//func MOD(n, m field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "MOD(?, ?)",
//		Vars: []any{n, m},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Pow 方法替代，如 expr.Pow(exponent)
//// POWER 返回X的Y次幂，是POW的同义词
//// SELECT POWER(2, 3);
//// SELECT POWER(10, 2);
//// SELECT POWER(5, -1);
//// SELECT POWER(users.level, 2) FROM users;
//func POWER(x, y field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "POWER(?, ?)",
//		Vars: []any{x, y},
//	})
...
//func POW(x, y field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "POW(?, ?)",
//		Vars: []any{x, y},
//	})
//}
//
//// Deprecated: 使用 Int/Float/Decimal 的 Sqrt 方法替代，如 expr.Sqrt()
//// SQRT 返回X的平方根，X必须为非负数
//// SELECT SQRT(4);
//// SELECT SQRT(16);
//// SELECT SQRT(2);
//// SELECT SQRT(area) as side_length FROM squares;
//func SQRT(x field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "SQRT(?)",
//		Vars: []any{x},
//	})
...
//// Deprecated: 使用 Int/Float/Decimal 的 Sign 方法替代，如 expr.Sign()
//// SIGN 返回数值的符号：负数返回-1，零返回0，正数返回1
//// SELECT SIGN(-10);
//// SELECT SIGN(0);
//// SELECT SIGN(10);
//// SELECT SIGN(balance) FROM accounts;
//func SIGN(x field.Expression) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "SIGN(?)",
//		Vars: []any{x},
//	})
...
//// Deprecated: 使用 Int/Float/Decimal 的 Truncate 方法替代，如 expr.Truncate(decimals)
//// TRUNCATE 截断数值到指定小数位数，不进行四舍五入
//// SELECT TRUNCATE(4.567, 2);
//// SELECT TRUNCATE(4.567, 0);
//// SELECT TRUNCATE(123.456, -1);
//// SELECT TRUNCATE(price, 2) FROM products;
//func TRUNCATE(x field.Expression, d int) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "TRUNCATE(?, ?)",
//		Vars: []any{x, d},
//	})
...
//// 例如: DateTime.Format(), DateTime.Year(), DateTime.AddInterval() 等
//
//// DATE_FORMAT 格式化日期/时间为指定字符串，支持各种格式化符号
//// Deprecated: 使用 DateTime.Format() 或 Date.Format() 代替
//// SELECT DATE_FORMAT(NOW(), '%Y-%m-%d %H:%i:%s');
//// SELECT DATE_FORMAT('2023-10-26', '%Y年%m月%d日');
//// SELECT DATE_FORMAT(users.birthday, '%W %M %Y') FROM users;
//// SELECT DATE_FORMAT(NOW(), '%Y%m%d%H%i%s');
//func DATE_FORMAT(date field.Expression, format string) field.String[string] {
...
//// Deprecated: 使用 DateTime.Month() 或 Date.Month() 代替
//// SELECT MONTH(NOW());
...
//func MONTH(date field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "MONTH(?)",
//		Vars: []any{date},
//	})
...
//// Deprecated: 使用 DateTime.Week() 或 Date.Week() 代替
//// SELECT WEEK(NOW());
//// SELECT WEEK('2023-10-26');
//// SELECT WEEK(NOW(), 1);
//// SELECT * FROM orders WHERE WEEK(order_date) = WEEK(NOW());
//func WEEK(date field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "WEEK(?)",
//		Vars: []any{date},
//	})
...
//// Deprecated: 使用 DateTime.WeekOfYear() 或 Date.WeekOfYear() 代替
...
//func WEEKOFYEAR(date field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "WEEKOFYEAR(?)",
//		Vars: []any{date},
//	})
...
//// Deprecated: 使用 DateTime.Hour() 或 Time.Hour() 代替
//// SELECT HOUR(NOW());
...
//func HOUR(time field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "HOUR(?)",
//		Vars: []any{time},
//	})
...
//// Deprecated: 使用 DateTime.Minute() 或 Time.Minute() 代替
//// SELECT MINUTE(NOW());
...
//func MINUTE(time field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "MINUTE(?)",
//		Vars: []any{time},
//	})
...
//// Deprecated: 使用 DateTime.Second() 或 Time.Second() 代替
//// SELECT SECOND(NOW());
...
//func SECOND(time field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "SECOND(?)",
//		Vars: []any{time},
//	})
...
//// Deprecated: 使用 DateTime.DayOfWeek() 或 Date.DayOfWeek() 代替
...
//func DAYOFWEEK(date field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "DAYOFWEEK(?)",
//		Vars: []any{date},
//	})
...
//// Deprecated: 使用 DateTime.DayOfYear() 或 Date.DayOfYear() 代替
...
//func DAYOFYEAR(date field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "DAYOFYEAR(?)",
//		Vars: []any{date},
//	})
...
//// Deprecated: 使用 DateTime.AddInterval() 或 Date.AddInterval() 代替
...
//// Deprecated: 使用 DateTime.SubInterval() 或 Date.SubInterval() 代替
...
//// Deprecated: 使用 DateTime.DateDiff() 或 Date.DateDiff() 代替
...
//func DATEDIFF(expr1, expr2 field.Expression) field.Int[int64] {
//	return field.NewIntExprT[int64](clause.Expr{
//		SQL:  "DATEDIFF(?, ?)",
//		Vars: []any{expr1, expr2},
//	})
...
//// Deprecated: 使用 DateTime.TimeDiff() 或 Time.TimeDiff() 代替
...
//// Deprecated: 使用 DateTime.TimestampDiff() 代替
...
//// 支持单位: MICROSECOND, SECOND, MINUTE, HOUR, DAY, WEEK, MONTH, QUARTER, YEAR
//func TIMESTAMPDIFF(unit string, expr1, expr2 field.Expression) field.Int[int64] {
//	// 验证单位参数
...
//func INET_ATON(expr string) field.Int {
//	return field.NewIntExpr(clause.Expr{
//		SQL:  "INET_ATON(?)",
//		Vars: []any{expr},
//	})
...
//func SUM(expr field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "SUM(?)",
//		Vars: []any{expr},
//	})
...
//func AVG(expr field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "AVG(?)",
//		Vars: []any{expr},
//	})
...
//func MAX(expr field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "MAX(?)",
//		Vars: []any{expr},
//	})
...
//func MIN(expr field.Expression) field.Float {
//	return field.NewFloatExpr(clause.Expr{
//		SQL:  "MIN(?)",
//		Vars: []any{expr},
//	})
