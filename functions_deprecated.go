...
//// Deprecated: 使用 StringExpr 的 Concat 方法替代，如 textExpr.Concat(args...)
...
//// Deprecated: 使用 StringExpr 的 Length 方法替代，如 textExpr.Length()
...
//}
//
//// Deprecated: 使用 StringExpr 的 CharLength 方法替代，如 textExpr.CharLength()
...
//// Deprecated: 使用 StringExpr 的 Upper 方法替代，如 textExpr.Upper()
...
//// Deprecated: 使用 StringExpr 的 Lower 方法替代，如 textExpr.Lower()
...
//// Deprecated: 使用 StringExpr 的 Substring 方法替代，如 textExpr.Substring(pos, length)
...
//// Deprecated: 使用 StringExpr 的 Left 方法替代，如 textExpr.Left(length)
...
//// Deprecated: 使用 StringExpr 的 Right 方法替代，如 textExpr.Right(length)
...
//}
//
//// Deprecated: 使用 StringExpr 的 Locate 方法替代，如 textExpr.Locate(substr)
...
//}
//
//// Deprecated: 使用 StringExpr 的 Replace 方法替代，如 textExpr.Replace(from, to)
...
//}
//
//// Deprecated: 使用 StringExpr 的 Trim 方法替代，如 textExpr.Trim()
...
//}
//
//// Deprecated: 使用 StringExpr 的 LTrim 方法替代，如 textExpr.LTrim()
//// LTRIM 去除字符串左侧的空格
...
//}
//
//// Deprecated: 使用 StringExpr 的 RTrim 方法替代，如 textExpr.RTrim()
//// RTRIM 去除字符串右侧的空格
...
//// SELECT DATE_FORMAT(NOW(), '%Y%m%d%H%i%s');
//func DATE_FORMAT(date field.Expression, format string) field.StringExpr[string] {
